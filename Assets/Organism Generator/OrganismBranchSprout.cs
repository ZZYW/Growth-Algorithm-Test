...
public class OrganismBranchSprout : MonoBehaviour {
	...
	float yIncrement = Random.Range(-0.2f, 0.2f);
	float xIncrement = Random.Range(-1f, 1f);
	float zIncrement = Random.Range(-1f, 1f);
	...
	public void addObject ()
	{
		...
		if (Random.Range (0, 100) > 86) {
			...
			gameObject.transform.parent.GetComponent<Organism> ().addBranch(previousObjectPos,"Sprout");
		}
		//end
