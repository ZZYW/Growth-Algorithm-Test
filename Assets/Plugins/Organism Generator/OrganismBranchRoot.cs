...
public class OrganismBranchRoot : MonoBehaviour
{
	...
	{
		Vector3 previousObjectPos = gameObject.transform.parent.GetComponent<Organism>().baseObject.transform.position; //default pos is branch's base position
		...
		newObject.transform.position = previousObjectPos + Vector3.up * myParent.GetComponent<Organism>().objectDropingDistance + Vector3.left/5;
